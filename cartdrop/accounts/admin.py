...
SIMPLE_PERMISSION_FIELDS = (_('Permissions'), {
    'fields': ('is_active', 'is_staff', 'is_superuser', "is_email_verified", "is_number_verified", "is_disabled"),
})

ADVANCE_PERMISSION_FIELDS = (_('Advance Permission'), {
...
class CartDropUserAdmin(UserAdmin):
    ...
    model = CartDropUser
    list_display = ('username', 'email', 'number', 'is_active', "is_email_verified", 'is_number_verified')
    list_display_links = (USERNAME_FIELD,)
    list_filter = ('is_active', "is_email_verified", 'is_number_verified', "is_disabled", "is_superuser", "is_staff")
