...
class CartDropUser(AbstractBaseUser, PermissionsMixin):
    ...
    number = models.CharField(_("Mobile Number"), max_length=10, unique=True, db_index=True, blank=True, error_messages={'unique': _("This number is already registered with us please try logging in")})
    ...
    type = models.CharField(_('user type'),max_length=100, db_index=True, default=UserTypes.CUSTOMER)
    ...
    is_email_verified = models.BooleanField(_('email verified'), default=False, help_text='Designates whether the user has verified their email')
    is_number_verified = models.BooleanField(_('number verified'), default=False, help_text='Designates whether the user has verified their number')
    is_disabled = models.BooleanField(_('disabled'), default=False, help_text="Designates whether the user account has been disabled")
