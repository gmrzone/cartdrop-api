...
from .models import (ACType, DisplayType, MobileVariant, OperatingSystem,
                     ...
                     WashingMethod, ProductLaptopFeatures, ProductTelivisionFeatures, ProductWashingMachineFeatures, 
                     ProductAirConditionerFeature, ProductRefrigeratorFeature, ProductSpeakersFeatures)
...
class WashingMachineFeatureAdmin(admin.ModelAdmin):
    list_display = ('energy_rating', 'washing_capicity', 'washing_method', 'has_inbuilt_heater')
